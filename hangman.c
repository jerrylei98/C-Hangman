...
int main(){
  printf("word: %s, definition: %s\n", words[5], definitions[5]);
  printf("%s%s%s%s%s%s%s", hangman_numbers[0], hangman_numbers[1], hangman_numbers[2], hangman_numbers[3], hangman_numbers[4], hangman_numbers[5], hangman_numbers[6]);
}
